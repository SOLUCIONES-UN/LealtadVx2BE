...
const obtienePremiosPendintes = async (infoBilletera, infoCampania) => {
    try {
        const premiosPendientes = await sequelize.query(`SELECT c.id, DATE_FORMAT(c.fecha, '%d%m%Y%H%i%s') 
            AS fechaParticipacion, c.urlPremio, p.link, p.claveSecreta 
            FROM participacions c 
            INNER JOIN premios p ON p.id = c.idPremio 
            WHERE c.customerId=${infoBilletera.customer_id} 
            AND c.idCampania=${infoCampania.id} 
            AND c.jugado=0 AND p.idTransaccion=0 ORDER BY c.id DESC;`, { type: Sequelize.QueryTypes.SELECT });
...
const validaCupon = async (idRevision, cupon) => {
    const defData = {
        ...
        imgSuccess: "data:image/png;base64,",
        codFail: "11111111",
        codSucess: "",
    }
    ...
    try {
        ...
        if(!infoPremio.status) {
            ...
            return { status: false, data: { 
                imagen: infoCupon.data.newImgFail!='' ? infoCupon.data.newImgFail : defData.imgFail, 
                premio: '', 
                codigo: defData.codFail, premio: `` }, 
                message: `${infoPremio.message}` };
        }
        ...
        if(!cuponParticipa.status) {
            ...
            actualizaBitacora(newBitacora.status ? newBitacora.data.id : 0, dataBitacora.toString(), 2);
            return { status: false, data: { 
                imagen: infoCupon.data.newImgFail!='' ? infoCupon.data.newImgFail : defData.imgFail, premio: '', 
                codigo: defData.codFail, 
                premio: `` }, 
                message: `${cuponParticipa.message}` };
        }
        
        const respu = { status: true, data: { 
            imagen: infoCupon.data.newImgSuccess!='' ? infoCupon.data.newImgSuccess : defData.imgSuccess, 
            premio: '', 
            codigo: defData.codSucess, 
            premio: `Felicidades! se ha acreditado un premio, ${infoPremio.data.descripcion}` }, 
            message: `${infoCupon.data.mesajeExito}` };
...
const cuponPromocionValido = async (idCupon) => {
    try {
        const regData = await sequelize.query(`SELECT dp.id, dp.esPremio, dp.estado, dp.idPromocion, dp.idPremioPromocion, pr.mesajeExito, pr.mesajeFail, pr.imgSuccess , pr.imgFail FROM promocions pr INNER JOIN detallepromocions dp ON dp.idPromocion=pr.id WHERE pr.fechaInicio<=CURDATE() AND pr.fechaFin>=CURDATE() AND pr.estado=1 AND dp.cupon='${idCupon}';`, { type: Sequelize.QueryTypes.SELECT });
        if (regData.length==0) {
...
const obtienePremioCupon = async (infoCupon) => {
    try {
        ...
        regData[0].newImgSuccess = await getImgBase64(regData[0].imgSuccess);
...
const actualizaReferidos = async (id, dataInsert) => {
    try {
        const regData = await referidosIngresos.update(dataInsert, { where: { id }});
        return { status: true, data: regData, message: `Registro De Referidos Actualizado Con Exito` };
    } catch (error) {
        return { status: false, data: [], message: `Error: Intentando Actualizar El Registro De Referidos.` };
    }
}

const referidosOpciones = async (customerReference) => {
    try {
        const regData = await sequelize.query(`
            SELECT id, opcion, urlApi, iconoMostrar, 
            IFNULL(
                (
                    SELECT 
                        CASE 
                            WHEN DATEDIFF(now(), a.fecha) > 3 THEN 1 
                            WHEN a.id > 0 THEN 1 
                            ELSE 0 
                        END tieneCodigo 
                    FROM referidosingresos a 
                    INNER JOIN pronet.tbl_customer b ON a.customerId = b.customer_id 
                    AND b.customer_reference = :customerReference
                ), 0
            ) AS tieneCodigo 
            FROM configreferidos 
            WHERE estado = 1;
            `, 
            { 
                replacements: { customerReference }, 
                type: Sequelize.QueryTypes.SELECT 
            }
        );
...
const referidosValidaCodigo = async (customerReference, codigo) => {
    ...
    try {
        ...
        // REVISAR SI YA PARTICIPO
        const regParticipo = await sequelize.query(`SELECT COUNT(*) AS SiHay FROM referidosingresos WHERE estado>0 AND customerId=${regDataReferido.data.customer_id};`, { type: Sequelize.QueryTypes.SELECT });
        if(regParticipo[0].SiHay>0){
            dataBitacora.push(JSON.stringify({ status: false, data: regData.data, message: `Lo sentimos, el usuario referido ya participo` }));
            actualizaBitacora(newBitacora.status ? newBitacora.data.id : 0, dataBitacora.toString(), 4);
            return { status: false, data: [], message: `Lo sentimos, el usuario referido ya participo` };
        }
        //INSERTAR EL REGISTRO DEL REFERIDO
        const insData = await registraReferidos({ idCodigoReferido: regData[0].id, customerId: regDataReferido.data.customer_id });
        if (!insData.status){
        ...
        const transaccionReferido = await validaParticipacionTransaccion(regDataReferido.data.customer_id, "REF".concat(insData.data.id));
        const transaccionReferidor = await validaParticipacionTransaccion(regData[0].customerId, "REF".concat(insData.data.id));
        ...
        const updData = await actualizaReferidos(insData.data.id, { estado: (transaccionReferido.status && transaccionReferidor.status) ? 2 : (transaccionReferido.status ? 1 : (transaccionReferidor.status ? 3 : 0))});        
...
const validaParticipacionTerceros = async (codigoTercero, codigoUnico, idTrx, monto, numBilletera, cupo, fecha, adicionales) => {
    try{
        ...
        const transaccionTercero = await validaParticipacionTransaccion(regBilletera.data.customer_id, "TER".concat(registra.id));
