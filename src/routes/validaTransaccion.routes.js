...
const { updateConfig, GetConfig, AddCofig,updateCofigValidate,GetCampaniasConfig,DeleteConfig,GetCampaniasValidate, GetConfigById } = require('../controllers/configValidate.controller.js')
