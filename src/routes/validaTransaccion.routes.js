...
const { updateConfig, GetConfig, AddCofig,updateCofigValidate,GetCampaniasConfig,DeleteConfig,GetCampaniasValidate } = require('../controllers/configValidate.controller.js')
